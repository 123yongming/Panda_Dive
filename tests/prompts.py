"""Prompt templates and rubrics for LLM-as-judge evaluators.

This module contains all prompt templates used by the evaluators to assess
research report quality across multiple dimensions.
"""
